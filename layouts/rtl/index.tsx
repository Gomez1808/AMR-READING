...
import Footer from 'web/components/footer/FooterAdmin';
// Layout components
import Navbar from 'web/components/navbar/NavbarRTL';
import Sidebar from 'web/components/sidebar/Sidebar';
import { RtlProvider } from 'web/components/rtlProvider/RtlProvider';
import { PropsWithChildren, useEffect, useState } from 'react';
// import routes from 'web/routes';
import { getActiveNavbar, getActiveNavbarText, getActiveRoute, isWindowAvailable } from 'web/utils/navigation';
